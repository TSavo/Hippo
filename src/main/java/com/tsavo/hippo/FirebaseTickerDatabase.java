...
public class FirebaseTickerDatabase implements TickerDatabase {
	...
	public FirebaseTickerDatabase(String anExchangeName) {
	...
	@Override
	public void putAll(CurrencyPair aPair, Set<Trade> aList) {
		aList.forEach(trade -> {
	...
	static void close() {
		FirebaseTickerDatabase.running = false;
	}
}
